...
if ($property_id <= 0) {
    echo "Invalid property requested.";
    return;
}
...
$testimonials = [];
$table_check = @mysqli_query($conn, "SHOW TABLES LIKE 'testimonials'");
...
$property_description = isset($property['description']) && trim($property['description']) !== ''
    ? $property['description']
    : 'This property offers a comfortable, secure, and well-located stay with clean rooms, useful amenities, and a welcoming environment.';

if (empty($testimonials)) {
    $testimonials = [
        [
            'user_name' => 'Asha',
            'content' => 'Very clean and comfortable stay with friendly staff.'
        ],
        [
            'user_name' => 'Ravi',
            'content' => 'Great location and a very helpful management team.'
        ]
    ];
}
...
<body>
    ...
    <div class="property-about page-container">
        ...
        <p><?= htmlspecialchars($property_description, ENT_QUOTES, 'UTF-8') ?></p>
    </div>
    ...
    <div class="property-testimonials page-container">
        ...
        ?>
            <div class="testimonial-block">
                ...
                <div class="testimonial-name">- <?= htmlspecialchars($testimonial['user_name'], ENT_QUOTES, 'UTF-8') ?></div>
            </div>
        <?php
        }
        ?>
    ...
    <script>
        window.PG_LIFE_LOGGED_IN = <?= $user_id ? 'true' : 'false' ?>;
        window.PG_LIFE_PROPERTY_ID = <?= $property_id ?>;
        window.PG_LIFE_PROPERTY_NAME = <?= json_encode($property['property_name']) ?>;
    </script>
